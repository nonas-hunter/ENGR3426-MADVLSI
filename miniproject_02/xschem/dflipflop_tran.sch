...
C {madvlsi/gnd.sym} -30 110 0 0 {name=l2 lab=GND}
C {madvlsi/vdd.sym} -30 -90 0 0 {name=l3 lab=VDD}
...
C {madvlsi/vdd.sym} 130 -90 0 0 {name=l5 lab=VDD}
C {madvlsi/vdd.sym} 290 -90 0 0 {name=l6 lab=VDD}
C {madvlsi/vdd.sym} 450 -90 0 0 {name=l7 lab=VDD}
C {madvlsi/gnd.sym} 130 110 0 0 {name=l8 lab=GND}
C {madvlsi/gnd.sym} 290 110 0 0 {name=l9 lab=GND}
C {madvlsi/gnd.sym} 450 110 0 0 {name=l10 lab=GND}
